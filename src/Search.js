...
async function Search (){
    ...
    const response = await(await fetch(`http://www.omdbapi.com/?t=${inputValue.replaceAll(' ', '+')}&apikey=7236f328`)).json()//the replace all was added to combate the url needing pluses inbetween everything instead of spaces
